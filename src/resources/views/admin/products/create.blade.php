        ...
        <div class="card-body">
            ...
            <form action="{{route('admin.products.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="title" placeholder="ادخل اسم المنتج" required>
                </div>
                <div class="form-group">
                    <label for="sku"> رقم التخزين SKU</label>
                    <input type="number" class="form-control" name="sku" id="sku" placeholder="0000" required>
                </div>
                <div class="form-group">
                    <label for="description">تفاصيل المنتج</label>
                    <textarea class="form-control" name="description" id="description" rows="4"
                              placeholder="ادخل تفاصيل المنتج"></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" id="price" name="price" placeholder="ادخل سعر المنتج" required>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="box_items" id="box-items" placeholder="0" required>
                </div>
